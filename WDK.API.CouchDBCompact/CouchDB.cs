...
namespace WDK.API
{
    ...
    /// </summary>
    public class CouchDb : ConnectionBase
    {
        #region " Constructor "
        ...
        public JObject replicate(string content)
        {
            var result = DoRequest(getUrl() + "/_replicate", "POST", content, "application/json", false);
        ...
        public JObject replicate(object content)
        {
            var converters = new JsonConverter[] { new IsoDateTimeConverter() };
            var contentSerialized = JsonConvert.SerializeObject(content, converters);

            var result = DoRequest(getUrl() + "/_replicate", "POST", contentSerialized, "application/json", false);
        ...
        public DocumentInfo createDocument(string db, object content)
        {
            ...
            var jObject = JObject.Parse(contentSerialized);
            if (jObject["_id"] != null)
            {
                var value = jObject["_id"];
                if (value.ToString() == "null" || string.IsNullOrEmpty(value.ToString()) || value.ToString() == "\"\"")
                    jObject.Remove("_id");
            }
            var result = DoRequest(getUrl() + "/" + db, "POST", JsonConvert.SerializeObject(jObject), "application/json", false);
            //result	"{\"ok\":true,\"id\":\"4ac4e0e0f94b1e73e40403d1b3008263\",\"rev\":\"1-ce363ec7fbf74f9b1417ae0dfd605bfd\"}\n"	string
        ...
        public DocumentInfo updateDocument(string db, string docId, string content)
        {
            ...
            var result = DoRequest(getUrl() + "/" + db, "POST", JsonConvert.SerializeObject(jo), "application/json", false);
        ...
        public DocumentInfo updateDocument(string db, string docId, object content)
        {
            ...
            JsonConverter converters = new IsoDateTimeConverter();
            var jo = (JObject)(JsonConvert.DeserializeObject(JsonConvert.SerializeObject(content, converters)));
        ...
        public string getShowFunction(string dbName, string designDocument, string showFunctionName)
        {
            ...
            if ((dd["shows"] != null) && (dd["shows"][showFunctionName] != null))
            {
                return sanitizeOutput(dd["shows"][showFunctionName].ToString());
            }
        ...
        public string searchIndexes(string dbName, string designDocument, string listFunctionName)
        {
            var dd = (JObject)JsonConvert.DeserializeObject(getDocumentAsJson(dbName, designDocument));

            if ((dd["lists"] != null) && (dd["lists"][listFunctionName] != null))
            {
                return sanitizeOutput(dd["lists"][listFunctionName].ToString());
            }
        ...
        public string searchIndexes(string db, string name, string indexName, string parameters)
        {
            var param = String.Empty;
            ...
            var result =  DoRequest(getUrl() + "/" + db + "/_design/" + name + "/_search/" + indexName + param, "GET", false);
        ...
        public string getMapFunction(string dbName, string designDocument, string viewFunctionName)
        {
            ...
            {
                return sanitizeOutput(dd["views"][viewFunctionName]["map"].ToString());
            }
        ...
        public string getReduceFunction(string dbName, string designDocument, string viewFunctionName)
        {
            ...
            {
                return sanitizeOutput(dd["views"][viewFunctionName]["reduce"].ToString());
            }
        ...
        public string getValidateFunction(string dbName, string designDocument)
        {
            ...
            if (dd["validate_doc_update"] != null)
            {
                return sanitizeOutput(dd["validate_doc_update"].ToString());
            }
        ...
        public string getRewriteFunction(string dbName, string designDocument, int rewriteFunctionNumber)
        {
            ...
            {
                return sanitizeOutput(dd["rewrites"][rewriteFunctionNumber].ToString());
            }
        ...
        public string getFilterFunction(string dbName, string designDocument, string filterFunctionName)
        {
            ...
            if ((dd["filters"] != null) && (dd["filters"][filterFunctionName] != null))
            {
                return sanitizeOutput(dd["filters"][filterFunctionName].ToString());
            }
